const nameGirl = 'Nhuệ Nhuệ';
const giftUrl = 'http://nodemy.vn';
const eventName = 'Hộp quà cutee';
const titleCard = 'Tặng cho Nhuệ Nhuệ';
const contentCard = 'Mong những điều đẹp nhất sẽ đến với bạn trong hôm nay và cả những ngày sau';
